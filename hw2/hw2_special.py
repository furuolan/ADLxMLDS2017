...
"JntMAcTlOF0_50_70.avi.npy",
"klteYv1Uv9A_27_33.avi.npy",
"tJHUH9tpqPg_113_118.avi.npy",
"UbmZAe5u5FI_132_141.avi.npy"]#os.listdir(test_feat_path)    
...
test_output_txt_fd = open(output_csv, 'w')    

for idx, video_feat_id in enumerate(test_videos):    
    print (idx, video_feat_id)    
        
    video_feat_path = test_feat_path+video_feat_id    
    ...
    test_output_txt_fd.write(video_feat_id[:len(video_feat_id)-4] + ',')    
